...
/**
 * \class OnlineBeerGameLogicTest
 * \brief Class for BeerGame Logic
 */ 
class OnlineBeerGameLogicTest : public ::testing::Test {
protected:
    OnlineBeerGameLogicTest() {}
...
TEST_F(OnlineBeerGameLogicTest, orderReachesUpstreamTest) {
...
TEST_F(OnlineBeerGameLogicTest, shipmentReachesDownStream) {
    game->initGame();
    game->startGame();
